...
import com.kh.day12.view.MusicView;
...
public class Run {
		...
		do {
			...
			switch (choice) {
			//
			case 1:	music = view.inputMusicInfo();
					mController.addAtLast(music);
					view.displaySuccess("마지막 위치 에 추가 성공");
					break;
			case 2:
					music =  view.inputMusicInfo();
					mController.addAtZero(music);
					view.displaySuccess("첫 위치 에 추가 성공");
					break;
			...
			case 4:
				...
				= mController.searchMusicByName(title);
			...
			case 7:
				view.printMassage("------------곡명 오름차순 정렬-------------");
				mController.bubbleSortByTitleASC();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해주세요");
				break;
			case 8:
				view.printMassage("------------곡명 내림차순 정렬-------------");
				mController.bubbleSortByTitleDESC();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해주세요");
				break;
			case 9:
				view.printMassage("------------가수명 오름차순 정렬-------------");
				mController.bubbleSortBySingerASC();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해주세요");
				break;
			case 10:
				view.printMassage("------------가수명 내림차순 정렬-------------");
				mController.bubbleSortByTitleDESC();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해주세요");
				break;
			case 0: view.printMassage("프로그램 종료합니다");
					break;
	
			default:
				view.printMassage("잘못 입력하셧습니다.");
				break;
			}
		}while(choice !=0);
	}
